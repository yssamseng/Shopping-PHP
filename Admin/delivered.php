...
<body>
    ...
    <div class="p-2">
        <ul>
            ...
            <li><a class="active" href="delivered.php">รายการจัดส่งแล้ว</a></li>
    ...
    <br>
    <h1 class="text-warning text-center"> รายการจัดส่งแล้ว </h1>
    <br>
    <br>
    <br>
    <div style="border: 4px solid #123; padding:5px;">
        <h2>สินค้าได้รับการจัดส่งแล้ว</h2>
        <?php

    include "connect_database.php";
    $sql = "SELECT * from transection,account,book where book.book_id=transection.book_id and account.username = transection.username and transection_status='delivered' ";
